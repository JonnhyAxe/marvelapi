...
@ContextConfiguration(classes = { MarvelAPIConfig.class, MarvelApiLiveTestConfig.class, MarvelExternalAPIConfig.class }, loader = AnnotationConfigContextLoader.class)
